...
public class Precarga {
    ...
    public static List<Transito> cargarTransitos() {
        ...
        transitos
                .add(new Transito(puestos.get(0), vehiculos.get(0), tarifas.get(0), new Date(), bonificaciones.get(4)));
        transitos
                .add(new Transito(puestos.get(1), vehiculos.get(1), tarifas.get(0), new Date(), bonificaciones.get(1)));
        transitos
                .add(new Transito(puestos.get(2), vehiculos.get(5), tarifas.get(1), new Date(), bonificaciones.get(4)));
        transitos
                .add(new Transito(puestos.get(3), vehiculos.get(8), tarifas.get(2), new Date(), bonificaciones.get(2)));
        transitos
                .add(new Transito(puestos.get(4), vehiculos.get(2), tarifas.get(0), new Date(), bonificaciones.get(0)));
